...
export default function noturgentnotimportant({route}) {
  const navigation = useNavigation();
  const { tasks1 , tasks2 , tasks3 } = route.params;
  ...
  const handleDonePress = () => {
    ...
    `;
    navigation.navigate('Knowledge', { tasks1,tasks2, tasks3,tasks4: taskDetails });
  };

  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.title}>LIST OUT ALL THE NOT URGENT AND NOT IMPORTANT TASKS</Text>
      <Text style={styles.subtitle}>These are Low Value Tasks</Text>
