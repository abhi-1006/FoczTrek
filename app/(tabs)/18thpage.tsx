...
export default function Task5({ route }) {
  const navigation = useNavigation();
  const { tasks1, tasks2, tasks3, tasks4 , enttext1 , enttext2 , enttext3 , enttext4 } = route.params;
    ...
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <View style={styles.fullBackground}>
        <View style={styles.container}>
          <Image 
            source={require('../../assets/images/5.5.png')} 
            style={styles.image}
          />
          ...
          <Button
            title="DONE"
            onPress={() => navigation.navigate('Task5complete', {
              enttext5: ` ${text1} `,
              tasks1, tasks2, tasks3, tasks4 , enttext1 , enttext2 , enttext3 , enttext4
            })}
            color="#007bff"
          />
        </View>
