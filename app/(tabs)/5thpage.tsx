...
export default function Noturgentimportant({route}) {
  const navigation = useNavigation();
  const { tasks1 } = route.params;
  ...
  const handleDonePress = () => {
    ...
    `;
    navigation.navigate('urgentnotimportant', { tasks1,tasks2: taskDetails });
  };

  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.title}>LIST OUT ALL THE NOT URGENT AND IMPORTANT TASKS</Text>
      <Text style={styles.subtitle}>These are tasks that Contribute to Long-Term well being , these tasks can be scheduled</Text>
