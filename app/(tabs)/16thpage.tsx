...
export default function Task4({ route }) {
  const navigation = useNavigation();
  const { tasks1, tasks2, tasks3, tasks4 , enttext1 , enttext2 , enttext3 } = route.params;
    ...
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <View style={styles.fullBackground}>
        <View style={styles.container}>
          <Image 
            source={require('../../assets/images/4.4.png')} 
            style={styles.image}
          />
          ...
          <Button
            title="DONE"
            onPress={() => navigation.navigate('Task4complete', {
              enttext4: ` ${text1} `,
              tasks1, tasks2, tasks3, tasks4 , enttext1 , enttext2 , enttext3
            })}
            color="#007bff"
          />
        </View>
