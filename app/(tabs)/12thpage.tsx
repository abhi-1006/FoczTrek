...
export default function Task2({ route }) {
  const navigation = useNavigation();
  const { tasks1, tasks2, tasks3, tasks4 , enttext1 } = route.params;
    ...
    <ScrollView contentContainerStyle={styles.scrollContainer}>
      <View style={styles.fullBackground}>
        <View style={styles.container}>
          ...
          <Button
            title="DONE"
            onPress={() => navigation.navigate('Task2complete', {
              enttext2: ` ${text1} `,
              tasks1, tasks2, tasks3, tasks4 , enttext1
            })}
            color="#007bff"
          />
        </View>
